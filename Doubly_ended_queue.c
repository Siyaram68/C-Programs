...
int main()    
{   int m,n,i,j,a[20]; 
    printf("Enter no. of elements to be inserted from front:");
    scanf("%d",&m);
        printf("Enter no. of elements to be inserted from rear:");
            scanf("%d",&n);
    insert_front(a);
    {
        printf("Enter elements to be inserted from front side:");
            for(i=0;i<m;i++)
                {
                    printf("%d",&a[i]);
                }
